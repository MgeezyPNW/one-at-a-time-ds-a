...
const filterStringsWithVowels = (arr) => {
  // Solution code here...
  let regex = /[aeiou]/gm;
  let results = arr.filter( str => ( str.match(regex) ));
  return(results);
};
...
const getBaseStatGreaterThan = (arr, minBaseStat) => {
  // Solution code here...
  return arr.filter(array => array.baseStat > minBaseStat);
};
...
const getStatName = (arr, minBaseStat) => {
  // Solution code here...
  let baseStatFilter = arr.filter(array => array.baseStat > minBaseStat);

  return baseStatFilter.map(array => array.stat.name);
...
const getCharactersWithoutChildren = arr => {
  // Solution code here...
  return arr.filter(array => !array.children);
};
